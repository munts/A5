...
<?php while ( have_posts() ) : the_post(); ?>
    ...
    <div class="white-section section-block">
        <div class="limit-width3">
            ...
            <?php
            $row_setup2 = get_post_meta( $post->ID, 'a5_layout_group', true ); // this particular instance spits out 33 which is entered into a field in wp-admin
            $count = 0;
