...
?>
    ...
    <div class="fullwidthbanner-container main-carousel2">
        <div Class="row">
            <div class="col-xs-10 col-md-11" style="padding:0;">
                <?php
            ...
            <div class="col-xs-2 col-md-1" style="padding:0;height:100%;">
                <div class="icon-style-1">
                    <div class="icon-nav">
                        <div id="van">
                            <img src="/wp-content/uploads/2018/05/van.png" style="width:50%;margin:15px auto;" class="img-responsive">
                        </div>
                        <div class="icon-label hidden-xs hidden-sm">
                            Sprinter Vans
                        </div>
                    </div>
                    <div class="icon-nav">
                        <div id="jeep">
                            <img src="/wp-content/uploads/2018/05/jeep.png" style="width:50%;margin:15px auto;" class="img-responsive">
                        </div>
                        <div class="icon-label hidden-xs hidden-sm">
                            Off-Road Jeeps
                        </div>
                    ...
                    <div class="icon-nav">
                        <div id="plane">
                            <img src="/wp-content/uploads/2018/05/plane.png" style="width:50%;margin:15px auto;" class="img-responsive">
                        </div>
                        <div class="icon-label hidden-xs hidden-sm">
                            Amphibious<br> Planes
                        </div>
                    </div>
                    <div class="icon-nav">
                        <div id="boat">
                            <img src="/wp-content/uploads/2018/05/boat.png" style="width:50%;margin:15px auto;" class="img-responsive">
                        </div>
                        <div class="icon-label hidden-xs hidden-sm">
                            Ski Boats
                        </div>
                    ...
                    <div class="icon-nav">
                        <div id="ski">
                            <img src="/wp-content/uploads/2018/05/ski.png" style="width:50%;margin:15px auto;" class="img-responsive">
                        </div>
                        <div class="icon-label hidden-xs hidden-sm">
                            Ski Packages
                        </div>
                    ...
                    <div class="icon-nav">
                        <div id="house">
                            <img src="/wp-content/uploads/2018/05/house.png" style="width:50%;margin:15px auto;" class="img-responsive">
                        </div>
                        <div class="icon-label hidden-xs hidden-sm">
